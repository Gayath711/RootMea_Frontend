...
function Preview({ items, title, additionalDetails, showModal, labelTitleList, widthList, checkboxList, columnTypeList, enumList, tableName }) {
    ...
    <div>
            <ul className="grid grid-cols-1 gap-4">
                    ...
                    >
                        ...
                        <h3 className="text-base font-medium text-gray-700">{additionalDetails}</h3>
                    </motion.li>
