...
function DragDropDemo() {
  ...
  function handleRemove(index) {
    ...
    setCheckboxList(prevCheckboxes => prevCheckboxes.filter((_, i) => i !== index));
  ...
  <form role="form" className="w-3/4" >
    ...
    <div className="form-group">
      ...
      <div className="row pt-4">
        ...
        <div className="input-group mb-3 justify-content-center pt-4 " style={{ width: '90%', margin: 'auto' }}>
              <input
                type="text"
            ...
            <p className='pb-4' style ={{ color: '#5bc4bf', fontWeight: 'bold' }}>Elaments Name</p>


            <div className='row'>
              <div className='col-6'>
                <p draggable="true" onDragStart={e => handleDragStart(e, 'VARCHAR(250)')} className="drag">
                ...
                <span style={{ fontWeight: 'bold', marginLeft: '10%' }}>Text</span>
              </Button>
                </p>
              </div>
              <div className='col-6'>
                <p draggable="true" onDragStart={e => handleDragStart(e, 'TEXT')} className="drag">
                  <Button variant="info" style={{ display: 'flex', alignItems: 'center', width: '100%', textAlign: 'center' }}>
                    <img src={file} alt="Text Icon" style={{ width: '15%', height: '15%', marginRight: '10px' }} />
                    <span style={{ fontWeight: 'bold', marginLeft: '10%' }}>TextArea</span>
                  </Button>
                </p>
              </div>
              <div className='col-6 pt-4'>
                <p draggable="true" onDragStart={e => handleDragStart(e, 'INTEGER')} className="drag">
                  <Button variant="info" style={{ display: 'flex', alignItems: 'center', width: '100%', textAlign: 'center' }}>
                    <img src={file} alt="Text Icon" style={{ width: '15%', height: '15%', marginRight: '10px' }} />
                    <span style={{ fontWeight: 'bold', marginLeft: '10%' }}>Number</span>
                  </Button>
                </p>
              </div>
            </div>

            <p className='pt-4' style ={{ color: '#5bc4bf', fontWeight: 'bold' }}>Elaments Name</p>

            <div className='row '>
              <div className='col-6 pt-4'>
                <p draggable="true" onDragStart={e => handleDragStart(e, 'FLOAT')} className="drag">
                  <Button variant="info" style={{ display: 'flex', alignItems: 'center', width: '100%', textAlign: 'center' }}>
                    <img src={file} alt="Text Icon" style={{ width: '15%', height: '15%', marginRight: '10px' }} />
                    <span style={{ fontWeight: 'bold', marginLeft: '10%' }}>Decimal</span>
                  </Button>
                </p>
              </div>
              <div className='col-6 pt-4'>
                <p draggable="true" onDragStart={e => handleDragStart(e, 'BOOLEAN')} className="drag">
                  <Button variant="info" style={{ display: 'flex', alignItems: 'center', width: '100%', textAlign: 'center' }}>
                    <img src={file} alt="Text Icon" style={{ width: '15%', height: '15%', marginRight: '10px' }} />
                    <span style={{ fontWeight: 'bold', marginLeft: '10%' }}>Boolean</span>
                  </Button>
                </p>
              </div>
              <div className='col-6 pt-4'>
                <p draggable="true" onDragStart={e => handleDragStart(e, 'TIMESTAMP')} className="drag">
                  <Button variant="info" style={{ display: 'flex', alignItems: 'center', width: '100%', textAlign: 'center' }}>
                    <img src={file} alt="Text Icon" style={{ width: '15%', height: '15%', marginRight: '10px' }} />
                    <span style={{ fontWeight: 'bold', marginLeft: '10%' }}>Date and Time</span>
                  </Button>
                </p>
              </div>
            </div>
            ...
            <div className='row'>
              <div className='col-6 pt-4'>
                <p draggable="true" onDragStart={e => handleDragStart(e, 'my_enum_type')} className="drag">
                  <Button variant="info" style={{ display: 'flex', alignItems: 'center', width: '100%', textAlign: 'center' }}>
                    <img src={file} alt="Text Icon" style={{ width: '15%', height: '15%', marginRight: '10px' }} />
                    <span style={{ fontWeight: 'bold', marginLeft: '10%' }}>Dropdown</span>
                  </Button>
                </p>
              </div>
              <div className='col-6 pt-4'>
              ...
              <div className='col-6 pt-4'>
                <p draggable="true" onDragStart={e => handleDragStart(e, 'BYTEA')} className="drag">
                  <Button variant="info" style={{ display: 'flex', alignItems: 'center', width: '100%', textAlign: 'center' }}>
                    <img src={file} alt="Text Icon" style={{ width: '15%', height: '15%', marginRight: '10px' }} />
                    <span style={{ fontWeight: 'bold', marginLeft: '10%' }}>Image Upload</span>
                  </Button>
                </p>
              </div>
              <div className='col-6 pt-4'>
                <p draggable="true" onDragStart={e => handleDragStart(e, 'BYTEA')} className="drag">
                  <Button variant="info" style={{ display: 'flex', alignItems: 'center', width: '100%', textAlign: 'center' }}>
                    <img src={file} alt="Text Icon" style={{ width: '15%', height: '15%', marginRight: '10px' }} />
                    <span style={{ fontWeight: 'bold', marginLeft: '10%' }}>File Upload</span>
                  </Button>
                </p>
              </div>
            </div>
        ...
        <div className="col-sm-8 pt-4" style={{ overflowY: "auto", maxHeight: "calc(100vh - 56px)", border: "2px solid #eaeceb" }}>
                ...
                case 'VARCHAR(250)':
                  ...
                  inputElement = (
                    <div key={key}>
                     ...
                     <label className="block mb-1" style={{ fontWeight: 'bold' }}>
                        {labelTitleList[index]}
                        {checkboxList[index] && <span style={{ color: 'red' }}> *</span>}
                      </label>
                      ...
                      <Button variant="info"  onClick={() => handleOpenModal(index)}>Open Modal</Button>
                      ...
                      <Modal show={showModal[index]} onHide={() => handleCloseModal(index)}>
                          ...
                          <Modal.Body>
                        <div className='pb-4'>
                          <label htmlFor="textTitle" className="block mb-1">Text Title</label>
                          <input
                            id="textTitle"
                        ...
                        <div className="pb-4">
                          <label htmlFor="selectWidth" className="block mb-1">Width</label>
                          <select
                            id="selectWidth"
                    ...
                    <Modal.Footer>
                      ...
                      <Button variant="info"  onClick={() => { handleCloseModal(index); handleColumnTypeChange(index, 'VARCHAR(250)'); handleEnumChange(index, []); }}>Save changes</Button>
          ...
          inputElement = (
            ...
            <Modal.Footer>
              ...
              <Button variant="info"  onClick={() => { handleCloseModal(index); handleColumnTypeChange(index, 'INTEGER'); handleEnumChange(index, []); }}>Save changes</Button>
          ...
          inputElement = (
            ...
            className={`${widthList[index] === undefined ? 'w-full' : widthList[index]} border border-gray-300 rounded px-4 py-2`}
            disabled
          />
              </div>
              <div className="col-auto">
            ...
            <Modal.Footer>
              ...
              <Button variant="info"  onClick={() => { handleCloseModal(index); handleColumnTypeChange(index, 'TEXT'); handleEnumChange(index, []); }}>Save changes</Button>
        ...
        inputElement = (
          ...
          <Modal.Footer>
            ...
            <Button variant="info"  onClick={() => { handleCloseModal(index); handleColumnTypeChange(index, 'FLOAT'); handleEnumChange(index, []); }}>Save changes</Button>
        ...
        inputElement = (
          ...
          <Modal.Footer>
            ...
            <Button variant="info"  onClick={() => { handleCloseModal(index); handleColumnTypeChange(index, 'BOOLEAN'); handleEnumChange(index, []); }}>Save changes</Button>
        ...
        inputElement = (
          ...
          <Modal.Footer>
            ...
            <Button variant="info"  onClick={() => { handleCloseModal(index); handleColumnTypeChange(index, 'BYTEA'); handleEnumChange(index, []); }}>Save changes</Button>
        ...
        inputElement = (
          ...
          <Modal.Footer>
            ...
            <Button variant="info"  onClick={() => { handleCloseModal(index); handleColumnTypeChange(index, 'TIMESTAMP'); handleEnumChange(index, []); }}>Save changes</Button>
      ...
      <button onClick={handleClick} className="bg-Teal-500 hover:bg-Teal-700 text-block font-bold mt-2.5 py-2 px-4 rounded mb-4 mr-2 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-Teal-500 w-48" style={{ borderRadius: '3px', background: '#9CDADA', fontSize: '1rem' }}>Create Form</button>
    </div>
        </div>
      </div>
