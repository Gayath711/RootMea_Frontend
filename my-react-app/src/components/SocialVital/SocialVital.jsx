...
const SocialVital = () => {
  ...
  return (
    <div
      id="social-vital-1"
      className="bg-white rounded-md shadow-md min-[320px]:h-full col-span-3 flex-1"
    >
      <div className="flex justify-between items-center px-4 mt-6 mb-2">
        ...
        <button
          id="social-vital-3"
          className="flex justify-center items-center space-x-2 border border-[#2F9384] px-2 py-0.5 rounded-sm"
        >
      ...
      <div
        id="social-vital-6"
        className="flex justify-around items-center my-3 mx-0"
      >
        ...
        <button
          id="social-vital-10"
          className="px-2.5 text-white py-1.5 font-medium text-xs bg-[#7397B5] rounded-sm"
        >
          View Details
        </button>
      </div>
