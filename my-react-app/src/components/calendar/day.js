            ...
            return (
              <>
                <div className="m-2 relative">
                  <a
                    href={event.htmlLink}
                    className="flex flex-col space-y-8 w-full h-20 left-0 top-0 absolute bg-white rounded-sm shadow event-container transition-opacity duration-500 transform hover:scale-105"
                  >
                    <div
                      className={`w-full h-7 left-0 top-0 absolute ${getTitleBackGround()} rounded-tl-sm rounded-tr-sm p-2`}
                    >
